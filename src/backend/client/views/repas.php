...
<header class="header">
    <nav class="nav-container">
        ...
        <ul class="liens-navigation">
            ...
            <li><a href="#mpc" class="lien">Menu</a></li>
            <li><a href="#kq" class="lien">Ma Commande</a></li>
        </ul>
    ...
    <nav class="menu-mobile" aria-label="Menu mobile">
        <ul>
            ...
            <li><a href="#mpc" class="lien-mobile">Menu</a></li>
            <li><a href="#kp" class="lien-mobile">Ma Commande</a></li>
...
<main>
    <section id="mpc" class="activites" aria-label="Activités Phare">
        <div class="conteneur-activites">
            <header class="entete-section">
                <h1>Menu Repas JI 2025</h1>
                <p>Découvrez nos plats préparez avec amour</p>
            </header>
                    ...
                    <div class="overlay-details-content" style="display: none;">
                        <div class="detail-image-col">
                            <img src="backend/client/assets/images/novBleu_large.webp"
                                 alt="Conférence Innovation & Tech - Détail">
                        </div>
                        <div class="detail-info-col">
                            <h2 class="detail-titre">Repas</h2>
                            <h3 class="detail-soustitre">Nom nourriture</h3>
                            ...
                            <form action="/commander/repas/1" method="POST">
                                <input type="hidden" name="user_id" value="<?= $utilisateur['id'] ?? '' ?>">
                                <button type="submit" class="btn-commander">Voter pour ce projet</button>
                            </form>
                        </div>
                    </div>
                </article>
    ...
    <section id="kq" class="activites">
        Barreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    </section>
